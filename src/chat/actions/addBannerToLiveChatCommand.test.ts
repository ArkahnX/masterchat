			...
			liveChatBannerRenderer: {
							...
							buttonRenderer: {
								...
								command: {
									...
									liveChatItemContextMenuEndpoint: {
										params: "Q2g0S0hBb2FRMHhxZDIxTlUyNTNkbWREUm1GSlVuSlJXV1JrZGtGRWVHY2FLU29uQ2hoVlEyNUNSSGxhVTIweFV6SlZSbmRuZWtONVNXSkRVV2NTQzNsNWJGRnVYMUZXVVdjMElBRW9BVElhQ2hoVlEyNUNSSGxhVTIweFV6SlZSbmRuZWtONVNXSkRVV2M0QVVnQVVCbyUzRA==",
									},
								},
							},
						},
				...
				contents: {
					liveChatProductItemRenderer: {
						...
						accessibilityTitle: "Everything Fox, €34.61 (taxes included) + additional fees, from Spring",
						thumbnail: {
							thumbnails: [
								{

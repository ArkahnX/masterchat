...
import { IterateChatOptions, Masterchat, MasterchatOptions } from "./masterchat";
...
export interface StreamPool {
	on<U extends keyof StreamPoolEvents>(event: U, listener: StreamPoolEvents[U]): this;
	addListener<U extends keyof StreamPoolEvents>(event: U, listener: StreamPoolEvents[U]): this;
	off<U extends keyof StreamPoolEvents>(event: U, listener: StreamPoolEvents[U]): this;
	removeListener<U extends keyof StreamPoolEvents>(event: U, listener: StreamPoolEvents[U]): this;
	emit<U extends keyof StreamPoolEvents>(event: U, ...args: Parameters<StreamPoolEvents[U]>): boolean;
}
...
export class StreamPool extends EventEmitter {
	 ...
	 */
	subscribe(videoId: string, channelId: string, iterateOptions?: IterateChatOptions): Masterchat {

...
it("toVideoId", () => {
	expect(toVideoId("https://www.youtube.com/watch?list=PLziarN-vZTxELklDgc_y0q-ynm3DHylaS&v=nya_a4ysYso")).toBe("nya_a4ysYso");
});
		...
		expect(
			textRunToPlainText({
				...
				navigationEndpoint: {
					...
					watchEndpoint: {
						videoId: "yJ5agkia4o8",
						params: "ejFVZ3d4TGVveXVNandwVlFaalAxNEFhQUJBZy45S0JpWUZBN0g1dzlLR294QUd6MUVDogIDwAEA",
					},
				},
			})
		).toBe("1 day ago");

...
function prettyPrint(comment: YTCommentThreadRenderer) {
	...
	const membership = comment.comment.commentRenderer.sponsorCommentBadge?.sponsorCommentBadgeRenderer.tooltip;
	...
	console.log("id:", id, "membership:", membership, "author:", authorName, "message:", message);
}

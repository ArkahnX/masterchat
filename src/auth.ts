...
export function buildBaseHeaders(cookies?: Record<string, string>): Record<string, string> {
	return {
		Cookie: genCookieString(cookies),
	};
}

export function buildAuthHeaders(creds: Credentials, cookies?: Record<string, string>): Record<string, string> {
